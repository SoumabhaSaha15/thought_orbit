    ...
    if ($targetEl) {
      if (!instances_default.instanceExists("CopyClipboard", $targetEl.getAttribute("id"))) {
        new CopyClipboard($triggerEl, $targetEl, {
          htmlEntities: htmlEntities && htmlEntities === "true" ? true : Default4.htmlEntities,
          contentType: contentType ? contentType : Default4.contentType
        });
      }
    } else {
    ...
    if ($triggerEl) {
      ...
      if ($dialEl) {
        ...
        new Dial($parentEl, $triggerEl, $dialEl, {
          triggerType: triggerType ? triggerType : Default6.triggerType
        });
      } else {
  ...
  document.querySelectorAll("[data-drawer-target]").forEach(function($triggerEl) {
    ...
    if ($drawerEl) {
      ...
      new Drawer($drawerEl, {
        ...
        bodyScrolling: bodyScrolling ? bodyScrolling === "true" ? true : false : Default8.bodyScrolling,
        backdrop: backdrop ? backdrop === "true" ? true : false : Default8.backdrop,
        edge: edge ? edge === "true" ? true : false : Default8.edge,
        edgeOffset: edgeOffset ? edgeOffset : Default8.edgeOffset
      });
    } else {
  ...
  function() {
    ...
    Dropdown2.prototype.show = function() {
      ...
      this._popperInstance.setOptions(function(options) {
        return __assign9(__assign9({}, options), { modifiers: __spreadArray(__spreadArray([], options.modifiers, true), [
  ...
  document.querySelectorAll("[data-dropdown-toggle]").forEach(function($triggerEl) {
    ...
    if ($dropdownEl) {
      ...
      new Dropdown($dropdownEl, $triggerEl, {
        ...
        offsetSkidding: offsetSkidding ? parseInt(offsetSkidding) : Default9.offsetSkidding,
        offsetDistance: offsetDistance ? parseInt(offsetDistance) : Default9.offsetDistance,
        delay: delay ? parseInt(delay) : Default9.delay,
        ignoreClickOutsideClass: ignoreClickOutsideClass ? ignoreClickOutsideClass : Default9.ignoreClickOutsideClass
      });
    } else {
...
var Popover = (
  ...
  function() {
    ...
    Popover2.prototype.show = function() {
      ...
      this._popperInstance.setOptions(function(options) {
        return __assign11(__assign11({}, options), { modifiers: __spreadArray2(__spreadArray2([], options.modifiers, true), [
          { name: "eventListeners", enabled: true }
        ], false) });
      });
      this._setupClickOutsideListener();
  ...
  document.querySelectorAll("[data-popover-target]").forEach(function($triggerEl) {
    ...
    if ($popoverEl) {
      ...
      new Popover($popoverEl, $triggerEl, {
        ...
        offset: offset2 ? parseInt(offset2) : Default11.offset,
...
var Tooltip = (
  ...
  function() {
    ...
    Tooltip2.prototype.show = function() {
      ...
      this._targetEl.classList.add("opacity-100", "visible");
      this._popperInstance.setOptions(function(options) {
        return __assign13(__assign13({}, options), { modifiers: __spreadArray3(__spreadArray3([], options.modifiers, true), [
          { name: "eventListeners", enabled: true }
        ], false) });
      });
      this._setupClickOutsideListener();
  ...
  document.querySelectorAll("[data-tooltip-target]").forEach(function($triggerEl) {
    ...
    if ($tooltipEl) {
      ...
      new Tooltip($tooltipEl, $triggerEl, {
        placement: placement ? placement : Default13.placement,
        triggerType: triggerType ? triggerType : Default13.triggerType
      });
    } else {
